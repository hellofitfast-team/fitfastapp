  ...
  handler: async (ctx) => {
    ...
    for (const email of clientEmails) {
      try {
        ...
        console.error("[Seed:resetClientUser] Failed to delete seed user", {
          email,
    ...
    try {
      ...
      console.error("[Seed:resetClientUser] Failed to create client user", {
        error: error instanceof Error ? error.message : String(error),
      });
      results.push(`ERROR in resetClientUser: ${error}`);
    }
  ...
  handler: async (ctx) => {
    ...
    for (const user of testUsers) {
      try {
        ...
        console.error("[Seed:seedTestUsers] Failed to seed user", {
          fullName: user.fullName,
          error: error instanceof Error ? error.message : String(error),
        });
...
const SEED_FOODS: FoodEntry[] = [
  ...
  {
    name: "Beef Liver (Kibda)",
    nameAr: "كبدة",
    category: "protein",
    tags: ["high_protein", "egyptian"],
    per100g: { calories: 135, protein: 20.4, carbs: 3.9, fat: 3.6 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    name: "Lamb Leg (Lean, Cooked)",
    nameAr: "لحم ضاني (فخذ)",
    category: "protein",
    tags: ["high_protein", "egyptian"],
    per100g: { calories: 191, protein: 28.3, carbs: 0, fat: 7.7 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "كفتة (خلطة لحم)",
    category: "protein",
    tags: ["high_protein", "egyptian"],
    per100g: { calories: 258, protein: 18, carbs: 3, fat: 19 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  },
  {
    ...
    nameAr: "سردين معلب",
    category: "protein",
    tags: ["high_protein", "omega_3", "egyptian"],
  ...
  },
  {
    ...
    category: "protein",
    tags: ["high_protein", "omega_3", "egyptian"],
    per100g: { calories: 262, protein: 23.9, carbs: 0, fat: 17.8 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  {
    name: "Basterma (Cured Beef)",
    nameAr: "بسطرمة",
    category: "protein",
    tags: ["high_protein", "egyptian", "middle_eastern"],
    per100g: { calories: 180, protein: 32, carbs: 1, fat: 5 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    name: "Pigeon (Hamam, Roasted)",
    nameAr: "حمام مشوي",
    category: "protein",
    tags: ["high_protein", "egyptian"],
    per100g: { calories: 187, protein: 23.5, carbs: 0, fat: 10.1 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "صدر بط بدون جلد",
    category: "protein",
    tags: ["high_protein"],
    per100g: { calories: 132, protein: 23.5, carbs: 0, fat: 3.6 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "حمص معلب",
    category: "protein",
    tags: ["high_protein", "high_fiber", "quick_prep", "middle_eastern"],
    per100g: { calories: 139, protein: 7.1, carbs: 22.5, fat: 2.4, fiber: 5.4 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  },
  {
    ...
    category: "carb",
    tags: ["egyptian"],
    per100g: { calories: 290, protein: 8.5, carbs: 54, fat: 4.5, fiber: 1.8 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "carb",
    tags: ["egyptian"],
    per100g: { calories: 380, protein: 6, carbs: 42, fat: 21 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "فريكة مطبوخة",
    category: "carb",
    tags: ["high_fiber", "egyptian", "middle_eastern"],
    per100g: { calories: 130, protein: 5.6, carbs: 24, fat: 1.3, fiber: 4.5 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "برغل مطبوخ",
    category: "carb",
    tags: ["high_fiber", "middle_eastern"],
  ...
  {
    name: "Vermicelli (Sha'riyya, Cooked)",
    nameAr: "شعرية مطبوخة",
    category: "carb",
    tags: ["egyptian"],
    per100g: { calories: 160, protein: 5.3, carbs: 32, fat: 0.5 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "carb",
    tags: ["middle_eastern"],
    per100g: { calories: 112, protein: 3.8, carbs: 23.2, fat: 0.2 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  {
    name: "Taro (Qolqas, Cooked)",
    nameAr: "قلقاس مطبوخ",
    category: "carb",
    tags: ["egyptian"],
    per100g: { calories: 142, protein: 0.5, carbs: 34.6, fat: 0.1, fiber: 5.1 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "carb",
    tags: [],
    per100g: { calories: 82, protein: 2.5, carbs: 18, fat: 0.6, fiber: 1.7 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "carb",
    tags: ["middle_eastern"],
    per100g: { calories: 275, protein: 9.1, carbs: 55.7, fat: 1.2, fiber: 2.2 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "خبز عربي أسمر",
    category: "carb",
    tags: ["high_fiber", "middle_eastern"],
    per100g: { calories: 262, protein: 9.8, carbs: 51, fat: 2.0, fiber: 7.4 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "carb",
    tags: ["egyptian"],
    per100g: { calories: 360, protein: 12.7, carbs: 72.8, fat: 1.1, fiber: 3.9 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "عسل نحل",
    category: "carb",
    tags: ["middle_eastern", "quick_prep"],
  ...
  {
    name: "Black Molasses (Asal Aswad)",
    nameAr: "عسل أسود",
    category: "carb",
    tags: ["egyptian"],
    per100g: { calories: 290, protein: 0, carbs: 75, fat: 0.1 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "carb",
    tags: ["quick_prep"],
    per100g: { calories: 357, protein: 7.5, carbs: 84, fat: 0.4, fiber: 1.2 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "carb",
    tags: ["egyptian"],
    per100g: { calories: 145, protein: 3, carbs: 30, fat: 1.2 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "carb",
    tags: ["high_fiber"],
    per100g: { calories: 124, protein: 5.3, carbs: 26.5, fat: 0.5, fiber: 3.9 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  {
    name: "Ghee (Samna Baladi)",
    nameAr: "سمنة بلدي",
    category: "fat",
    tags: ["egyptian"],
    per100g: { calories: 876, protein: 0, carbs: 0, fat: 99.5 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  },
  {
    ...
    nameAr: "فستق",
    category: "fat",
    tags: ["high_protein", "middle_eastern", "quick_prep"],
    per100g: { calories: 560, protein: 20.2, carbs: 27.2, fat: 45.3, fiber: 10.6 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "fat",
    tags: ["quick_prep"],
    per100g: { calories: 628, protein: 15, carbs: 16.7, fat: 60.7, fiber: 9.7 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "لب سوري",
    category: "fat",
    tags: ["high_protein", "egyptian", "quick_prep"],
  ...
  },
  {
    ...
    nameAr: "بذور شيا",
    category: "fat",
    tags: ["omega_3", "high_fiber", "quick_prep"],
    per100g: { calories: 486, protein: 16.5, carbs: 42.1, fat: 30.7, fiber: 34.4 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  {
    name: "Gibna Beyda (White Cheese)",
    nameAr: "جبنة بيضاء",
    category: "dairy",
    tags: ["egyptian", "middle_eastern"],
    per100g: { calories: 264, protein: 17.5, carbs: 1.3, fat: 21 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    name: "Gibna Roumy (Aged Cheese)",
    nameAr: "جبنة رومي",
    category: "dairy",
    tags: ["egyptian"],
    per100g: { calories: 393, protein: 25, carbs: 3.2, fat: 31 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  {
    name: "Laban Rayeb (Buttermilk)",
    nameAr: "لبن رايب",
    category: "dairy",
    tags: ["egyptian"],
    per100g: { calories: 40, protein: 3.3, carbs: 4.8, fat: 0.9 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  },
  {
    ...
    category: "dairy",
    tags: ["middle_eastern"],
    per100g: { calories: 321, protein: 21, carbs: 2.6, fat: 25 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "جبنة كريمي لايت",
    category: "dairy",
    tags: ["low_fat"],
    per100g: { calories: 201, protein: 8, carbs: 7.7, fat: 15.5 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  {
    name: "Molokhia Leaves (Raw)",
    nameAr: "ملوخية",
    category: "vegetable",
    tags: ["egyptian", "high_fiber"],
    per100g: { calories: 32, protein: 3.4, carbs: 4, fat: 0.2, fiber: 2 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "vegetable",
    tags: ["egyptian", "high_fiber"],
    per100g: { calories: 33, protein: 1.9, carbs: 7.5, fat: 0.2, fiber: 3.2 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "vegetable",
    tags: ["egyptian", "middle_eastern"],
    per100g: { calories: 25, protein: 1, carbs: 6, fat: 0.2, fiber: 3 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  },
  {
    ...
    category: "vegetable",
    tags: ["egyptian", "high_fiber"],
    per100g: { calories: 84, protein: 5.4, carbs: 15.6, fat: 0.2, fiber: 5.5 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  },
  {
    ...
    nameAr: "برتقال",
    category: "fruit",
    tags: ["quick_prep", "egyptian"],
    per100g: { calories: 47, protein: 0.9, carbs: 11.8, fat: 0.1, fiber: 2.4 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  },
  {
    ...
    category: "fruit",
    tags: ["egyptian", "high_fiber"],
    per100g: { calories: 68, protein: 2.6, carbs: 14.3, fat: 1, fiber: 5.4 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "fruit",
    tags: ["middle_eastern"],
    per100g: { calories: 83, protein: 1.7, carbs: 18.7, fat: 1.2, fiber: 4 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  // ==========================================================================
  // CONDIMENTS & SPREADS (~5 items)
  // ==========================================================================
  {
    name: "Duqqa (Egyptian Spice Mix)",
    nameAr: "دقة",
    category: "fat",
    tags: ["egyptian"],
    per100g: { calories: 490, protein: 18, carbs: 22, fat: 38, fiber: 8 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    nameAr: "حمص بطحينة",
    category: "fat",
    tags: ["middle_eastern", "high_fiber"],
  ...
  },
  {
    ...
    nameAr: "بابا غنوج",
    category: "fat",
    tags: ["middle_eastern", "egyptian"],
    per100g: { calories: 130, protein: 2.6, carbs: 11, fat: 8.6, fiber: 3 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  {
    ...
    category: "vegetable",
    tags: ["egyptian"],
    per100g: { calories: 82, protein: 4.3, carbs: 18.9, fat: 0.5, fiber: 4.1 },
    isRecipe: false,
    source: "usda",
    isVerified: true,
  },
  ...
  {
    name: "Foul Medames (Traditional)",
    nameAr: "فول مدمس تقليدي",
    category: "recipe",
    tags: ["egyptian", "high_protein", "high_fiber", "vegan"],
    per100g: { calories: 128, protein: 7.2, carbs: 17, fat: 3.2, fiber: 4.5 },
    isRecipe: true,
    servingSize: "1 bowl (250g)",
    perServing: { calories: 320, protein: 18, carbs: 42, fat: 8 },
    ingredients: [
      "200g cooked fava beans",
      "1 tbsp olive oil",
      "1 tbsp lemon juice",
      "1 tsp cumin",
      "Garlic, salt, chili flakes",
    ],
    instructions: [
      "Heat fava beans in their liquid",
      "Mash lightly with fork",
      "Season with cumin, lemon, garlic",
      "Drizzle olive oil and serve with baladi bread",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    ...
    category: "recipe",
    tags: ["egyptian", "vegan"],
    per100g: { calories: 280, protein: 10, carbs: 26, fat: 15 },
    isRecipe: true,
    servingSize: "4 pieces (120g)",
    perServing: { calories: 336, protein: 12, carbs: 31, fat: 18 },
    ingredients: [
      "200g dried fava beans (soaked overnight)",
      "1 bunch parsley, dill, cilantro",
      "1 onion, 4 garlic cloves",
      "1 tsp cumin, coriander",
      "Sesame seeds for coating",
    ],
    instructions: [
      "Grind soaked beans with herbs and spices",
      "Shape into flat patties",
      "Coat with sesame seeds",
      "Deep fry until golden (or air fry for healthy version)",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    name: "Molokhia Soup with Chicken",
    nameAr: "ملوخية بالدجاج",
    category: "recipe",
    tags: ["egyptian", "high_protein"],
    per100g: { calories: 55, protein: 5.5, carbs: 3, fat: 2.5 },
    isRecipe: true,
    servingSize: "1 bowl with chicken (400g)",
    perServing: { calories: 220, protein: 22, carbs: 12, fat: 10 },
    ingredients: [
      "300g molokhia leaves (chopped)",
      "150g chicken breast",
      "2 tbsp ghee or oil",
      "6 garlic cloves",
      "1 tsp coriander",
    ...
    instructions: [
      "Boil chicken in seasoned broth, shred",
      "Chop molokhia leaves finely",
      "Add molokhia to hot broth, stir",
      "Make ta'leya: fry garlic and coriander in ghee",
      "Pour ta'leya over soup, serve with rice",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    name: "Bamia Stew (Okra with Meat)",
    nameAr: "بامية باللحمة",
    category: "recipe",
    tags: ["egyptian", "high_protein"],
    per100g: { calories: 85, protein: 7, carbs: 5, fat: 4.5 },
    isRecipe: true,
    servingSize: "1 serving (300g)",
    perServing: { calories: 255, protein: 21, carbs: 15, fat: 13.5 },
    ingredients: [
      "200g okra (fresh or frozen)",
      "150g beef stew meat",
      "2 tomatoes, diced",
      "1 onion, 3 garlic cloves",
      "1 tbsp tomato paste, cumin",
    ],
    instructions: [
      "Brown beef in pot, set aside",
      "Sauté onion and garlic",
      "Add tomatoes, paste, and spices",
      "Return beef, add okra on top",
      "Simmer 30-40 min, serve with rice",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    name: "Mahshi Warak Enab (Stuffed Grape Leaves)",
    nameAr: "محشي ورق عنب",
    category: "recipe",
    tags: ["egyptian", "comfort_food"],
    per100g: { calories: 150, protein: 4, carbs: 18, fat: 7 },
    isRecipe: true,
    servingSize: "5 pieces (150g)",
    perServing: { calories: 225, protein: 6, carbs: 27, fat: 10.5 },
    ingredients: [
      "30 grape leaves",
      "200g Egyptian rice",
      "2 tomatoes, diced",
      "1 onion, herbs (dill, parsley)",
      "2 tbsp olive oil, lemon juice",
    ],
    instructions: [
      "Mix rice with tomatoes, onion, herbs, oil",
      "Place filling on grape leaf and roll tightly",
      "Layer rolls in pot over tomato slices",
      "Add water and lemon, simmer 45-60 min",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    ...
    category: "recipe",
    tags: ["egyptian", "comfort_food"],
    per100g: { calories: 95, protein: 5, carbs: 12, fat: 3 },
    isRecipe: true,
    servingSize: "2 pieces (250g)",
    perServing: { calories: 238, protein: 12.5, carbs: 30, fat: 7.5 },
    ingredients: [
      "4 medium zucchini, cored",
      "200g rice-meat filling (rice, ground beef, tomato, spices)",
      "Tomato sauce",
      "1 tsp dried mint",
    ],
    instructions: [
      "Core zucchini, keep shells intact",
      "Stuff with rice-meat mixture",
      "Place in pot, cover with tomato sauce",
      "Simmer 40-50 min until tender",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    name: "Fattah (Egyptian Rice & Bread)",
    nameAr: "فتة",
    category: "recipe",
    tags: ["egyptian", "high_protein", "comfort_food"],
    per100g: { calories: 160, protein: 9, carbs: 18, fat: 6 },
    isRecipe: true,
    servingSize: "1 plate (350g)",
    perServing: { calories: 560, protein: 31.5, carbs: 63, fat: 21 },
    ingredients: [
      "200g beef or lamb (cooked)",
      "100g Egyptian rice (cooked)",
      "2 pieces baladi bread (toasted)",
      "Vinegar-garlic tomato sauce",
      "Beef broth",
    ],
    instructions: [
      "Toast baladi bread, break into pieces",
      "Soak bread in vinegar broth",
      "Layer: bread, rice, meat",
      "Top with garlic-tomato sauce",
      "Optional: pour hot ghee on top",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    ...
    category: "recipe",
    tags: ["egyptian", "comfort_food"],
    per100g: { calories: 165, protein: 9, carbs: 16, fat: 7 },
    isRecipe: true,
    servingSize: "1 slice (250g)",
    perServing: { calories: 413, protein: 22.5, carbs: 40, fat: 17.5 },
    ingredients: [
      "300g penne pasta (cooked)",
      "200g ground beef (cooked with onion)",
      "500ml milk, 3 tbsp flour, 2 tbsp butter",
      "Salt, pepper, nutmeg",
    ],
    instructions: [
      "Cook pasta, layer with seasoned ground beef",
      "Make bechamel: melt butter, add flour, whisk in milk",
      "Pour bechamel over pasta layers",
      "Bake at 180°C for 25-30 min until golden",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    ...
    nameAr: "شكشوكة",
    category: "recipe",
    tags: ["egyptian", "middle_eastern", "high_protein", "quick_prep"],
    per100g: { calories: 95, protein: 6, carbs: 5, fat: 6 },
    isRecipe: true,
    servingSize: "1 serving (250g)",
    perServing: { calories: 238, protein: 15, carbs: 12.5, fat: 15 },
    ingredients: [
      "3 eggs",
      "3 tomatoes, diced",
      "1 bell pepper, 1 onion",
      "2 garlic cloves",
      "1 tbsp olive oil, cumin, paprika",
    ],
    instructions: [
      "Sauté onion, pepper, garlic in olive oil",
      "Add tomatoes and spices, simmer 10 min",
      "Make wells, crack eggs into sauce",
      "Cover and cook 5-7 min until eggs set",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    name: "Bissara (Fava Bean Dip)",
    nameAr: "بصارة",
    category: "recipe",
    tags: ["egyptian", "vegan", "high_fiber"],
    per100g: { calories: 95, protein: 6, carbs: 14, fat: 2 },
    isRecipe: true,
    servingSize: "1 bowl (200g)",
    perServing: { calories: 190, protein: 12, carbs: 28, fat: 4 },
    ingredients: [
      "200g dried split fava beans",
      "1 bunch dill, cilantro",
      "4 garlic cloves",
      "1 tbsp olive oil",
      "Cumin, salt, chili",
    ],
    instructions: [
      "Boil fava beans until very soft",
      "Add herbs and garlic, blend smooth",
      "Season with cumin and salt",
      "Serve topped with crispy onions and olive oil",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    ...
    category: "recipe",
    tags: ["egyptian", "high_protein"],
    per100g: { calories: 180, protein: 14, carbs: 5, fat: 12 },
    isRecipe: true,
    servingSize: "1 plate (300g, kofta + salad + bread)",
    perServing: { calories: 540, protein: 42, carbs: 35, fat: 25 },
    ingredients: [
      "200g kofta mix (beef/lamb, onion, parsley, spices)",
      "1 baladi bread",
      "Tomato-cucumber salad",
      "Tahini sauce",
    ],
    instructions: [
      "Shape kofta onto skewers or as patties",
      "Grill on high heat 3-4 min per side",
      "Serve with bread, salad, and tahini",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    name: "Protein Basbousa",
    nameAr: "بسبوسة بروتين",
    category: "recipe",
    tags: ["junk_made_healthy", "egyptian", "high_protein"],
    per100g: { calories: 190, protein: 14, carbs: 22, fat: 5 },
    isRecipe: true,
    servingSize: "1 piece (80g)",
    perServing: { calories: 152, protein: 11.2, carbs: 17.6, fat: 4 },
    ingredients: [
      "100g semolina",
      "2 scoops vanilla whey protein",
      "150g Greek yogurt (0% fat)",
      "2 eggs",
      "1 tbsp honey, 1 tsp baking powder",
    ],
    instructions: [
      "Mix semolina, protein powder, baking powder",
      "Add yogurt, eggs, honey — stir until smooth",
      "Pour into greased pan, score into diamonds",
      "Bake at 180°C for 20-25 min",
      "Optional: light sugar-free syrup drizzle",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    name: "High-Protein Foul Bowl",
    nameAr: "فول عالي البروتين",
    category: "recipe",
    tags: ["egyptian", "high_protein", "quick_prep"],
    per100g: { calories: 120, protein: 9, carbs: 12, fat: 4 },
    isRecipe: true,
    servingSize: "1 bowl (300g)",
    perServing: { calories: 360, protein: 27, carbs: 36, fat: 12 },
    ingredients: [
      "200g cooked fava beans",
      "2 boiled eggs (chopped)",
      "1 tbsp olive oil",
      "1 tbsp lemon juice",
      "Cumin, salt, chili, parsley",
    ],
    instructions: [
      "Heat fava beans, mash lightly",
      "Top with chopped boiled eggs",
      "Season with cumin, lemon, chili",
      "Drizzle olive oil, garnish with parsley",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    name: "Grilled Fish with Tahini",
    nameAr: "سمك مشوي بالطحينة",
    category: "recipe",
    tags: ["egyptian", "high_protein", "omega_3"],
    per100g: { calories: 130, protein: 16, carbs: 3, fat: 6 },
    isRecipe: true,
    servingSize: "1 fillet with sauce (250g)",
    perServing: { calories: 325, protein: 40, carbs: 7.5, fat: 15 },
    ingredients: [
      "200g tilapia or sea bass fillet",
      "2 tbsp tahini",
      "1 tbsp lemon juice",
      "2 garlic cloves",
      "Cumin, salt, paprika",
    ...
    instructions: [
      "Season fish with spices and lemon",
      "Grill or bake at 200°C for 15-20 min",
      "Mix tahini with lemon, garlic, water for sauce",
      "Serve fish with tahini sauce on the side",
    ],
    source: "verified_recipe",
    isVerified: true,
  },
  {
    ...
    category: "recipe",
    tags: ["egyptian", "high_fiber", "vegan", "comfort_food"],
    per100g: { calories: 65, protein: 4, carbs: 10, fat: 1 },
    isRecipe: true,
    servingSize: "1 bowl (350g)",
    perServing: { calories: 228, protein: 14, carbs: 35, fat: 3.5 },
    ingredients: [
      "150g mixed lentils",
    ...
    instructions: [
      ...
      "Add diced vegetables and lentils",
      "Cover with water, add spices",
      "Simmer 25-30 min, blend partially",
  ...
  },
  {
    ...
    category: "recipe",
    tags: ["egyptian", "high_protein", "quick_prep"],
    per100g: { calories: 145, protein: 8, carbs: 14, fat: 7 },
    isRecipe: true,
    servingSize: "1 plate (350g)",
    perServing: { calories: 508, protein: 28, carbs: 49, fat: 24.5 },
    ingredients: [
      "100g foul medames",
      "2 boiled eggs",
      "50g gibna beyda (white cheese)",
      "1 baladi bread",
      "Cucumber, tomato slices",
    ],
    instructions: [
      "Prepare foul with cumin and lemon",
      "Boil and peel eggs",
      "Arrange foul, eggs, cheese, vegetables on plate",
...
export const seedFoods = internalAction({
  ...
  handler: async (ctx) => {
    ...
    for (const food of SEED_FOODS) {
      try {
        const existing = await ctx.runQuery(internal.foodDatabase.findByName, {
          name: food.name,
        });
        if (existing) {
          skipped++;
          results.push(`[skip] ${food.name}`);
          continue;
        }
        await ctx.runMutation(internal.foodDatabase.insertFood, { ...food });
        inserted++;
        results.push(`[insert] ${food.name}`);
      } catch (error) {
        results.push(
          `[error] ${food.name}: ${error instanceof Error ? error.message : String(error)}`,
        );
      }
    }
    const summary = `[Seed] Food database: inserted ${inserted}, skipped ${skipped} existing (total seed: ${SEED_FOODS.length}).`;
    console.log(summary);
