...
- [x] **Phase 12: Design Tokens and Core Primitives** - Extended theme tokens, animation keyframes, and reusable UI primitives (completed 2026-02-22)
- [ ] **Phase 13: Page-Level Renovation** - Renovate all dashboard pages, auth pages, and empty states using new shell and primitives
- [ ] **Phase 14: Check-in Wizard and Onboarding** - Multi-step swipeable check-in form and guided onboarding assessment (1/3 plans complete)
- [ ] **Phase 15: RTL Audit and Polish** - Full RTL verification, accessibility audit, and PWA standalone testing
- [ ] **Phase 15.1: Unit Tests and Code Review** - Comprehensive codebase review + ~230 unit tests across all apps (INSERTED)
...
_Last updated: 2026-02-22 — Phase 14 plans created_

### Phase 15.1: Unit Tests and Code Review for Client, Admin, and Marketing Apps (INSERTED)

**Goal:** Comprehensive codebase review across all apps and Convex backend, followed by Vitest + @testing-library/react infrastructure with ~230 unit tests
**Depends on:** Phase 11.1 (all apps functional)
**Plans:** 7 plans (Plan 0: review, Plans 1-6: test infrastructure + tests)

Plans:

- [ ] 15.1-00: Full codebase review (4 parallel agents)
- [ ] 15.1-01: Test infrastructure setup
- [ ] 15.1-02: Client pure functions & Zod schemas (~62 tests)
- [ ] 15.1-03: Client hooks (~45 tests)
- [ ] 15.1-04: Client components & pages (~55 tests)
- [ ] 15.1-05: Admin components & pages (~30 tests)
- [ ] 15.1-06: Marketing checkout flow (~12 tests)
