  ...
  return (
    <div className="border-border bg-card overflow-hidden rounded-xl border">
      <div className="border-border flex items-center gap-2 border-b bg-neutral-50/50 p-4">
        ...
        <h3 className="text-sm font-semibold">{t("measurementsTitle")}</h3>
      </div>
      <div className="space-y-4 p-4">
        <div className="grid grid-cols-3 gap-3">
          <div>
            <label className="mb-1.5 block text-xs font-medium">
              {t("currentWeight")} ({tUnits("kg")})
            </label>
            <input
              type="number"
              step="0.1"
          ...
          <div>
            <label className="mb-1.5 block text-xs font-medium">{t("age")}</label>
            <input
              type="number"
              min={13}
              max={120}
        ...
        <div className="border-border border-t pt-3">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            {[
              ...
              <div key={key}>
                <label className="mb-1 block text-xs font-medium">{t(key)}</label>
                <input
                  type="number"
                  step="0.1"
                  value={value}
