...
export function GoalsSection({
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard
        icon={Target}
        title={t("assessment.primaryGoalTitle")}
        description={t("assessment.primaryGoalDesc")}
        variant="fitness"
      >
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  >
                    {t(`assessment.primaryGoals.${goal.id}`)}
                  </p>
                  <p className="mt-0.5 text-xs text-stone-400">
                    {t(`assessment.primaryGoals.${goal.id}_desc`)}
                  </p>
                </div>
              </button>
            );
      ...
      {primaryGoal && (
        <SectionCard
          icon={Target}
          title={t("assessment.secondaryFocusTitle")}
          description={t("assessment.secondaryFocusDesc")}
          variant="fitness"
        >
            ...
            {SECONDARY_FOCUSES.map((focus) => {
              ...
              return (
                ...
                >
                  ...
                  {t(`assessment.secondaryFocuses.${focus.id}`)}
                </button>
              );
            })}
          </div>
