        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://*.convex.cloud wss://*.convex.cloud https://*.sentry.io https://cdn.onesignal.com https://*.onesignal.com https://*.clerk.accounts.dev https://clerk.fitfast.app",
