...
const a = new Map(),
  ...
  A = (t, s) => {
    switch (s.type) {
      case "ADD_TOAST":
        return { ...t, toasts: [s.toast, ...t.toasts].slice(0, c) };
      case "UPDATE_TOAST":
        return {
          ...t,
      ...
      case "DISMISS_TOAST": {
        ...
        return (
          ...
          {
            ...t,
            toasts: t.toasts.map((o) => (o.id === e || e === void 0 ? { ...o, open: !1 } : o)),
          }
        );
      }
      case "REMOVE_TOAST":
...
function O({ ...t }) {
  const s = d(),
    e = (r) => n({ type: "UPDATE_TOAST", toast: { ...r, id: s } }),
