import { g as Q, s as H, b as Oe } from "./index.esm-D0Yx9_aU.js";
var v;
(function (r) {
  r.assertEqual = (n) => {};
  function e(n) {}
        ...
        for (const i of a.issues)
          if (i.code === "invalid_union") i.unionErrors.map(n);
            ...
            for (; c < i.path.length; ) {
              const u = i.path[c];
              (c === i.path.length - 1
                ? ((o[u] = o[u] || { _errors: [] }), o[u]._errors.push(t(i)))
                : (o[u] = o[u] || { _errors: [] }),
                (o = o[u]),
                c++);
            }
...
const Pe = (r) => {
  ...
  const c = s
    ...
    .slice()
    .reverse();
  for (const u of c) o = u(i, { data: e, defaultError: o }).message;
...
function l(r, e) {
  const t = $e(),
    s = Pe({
      ...
      data: r.data,
      path: r.path,
      errorMaps: [r.common.contextualErrorMap, r.schemaErrorMap, t, t === X ? void 0 : X].filter(
        (n) => !!n,
      ),
    });
...
const m = Object.freeze({ status: "aborted" }),
  D = (r) => ({ status: "dirty", value: r }),
  w = (r) => ({ status: "valid", value: r }),
  oe = (r) => r.status === "aborted",
  de = (r) => r.status === "dirty",
  $ = (r) => r.status === "valid",
...
class _ {
  ...
  "~validate"(e) {
    ...
    if (!this["~standard"].async)
      try {
        ...
        return $(a) ? { value: a.value } : { issues: t.common.issues };
      } catch (a) {
    ...
    return this._parseAsync({ data: e, path: [], parent: t }).then((a) =>
      $(a) ? { value: a.value } : { issues: t.common.issues },
    );
  }
  ...
  default(e) {
    ...
    return new te({ ...g(this._def), innerType: this, defaultValue: t, typeName: p.ZodDefault });
  }
  brand() {
    return new at({ typeName: p.ZodBranded, type: this, ...g(this._def) });
  }
  catch(e) {
    const t = typeof e == "function" ? e : () => e;
    return new re({ ...g(this._def), innerType: this, catchValue: t, typeName: p.ZodCatch });
  }
  describe(e) {
...
const Ve = /^c[^\s-]{8,}$/i,
  ...
  Le = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
  De = /^[a-z0-9_-]{21}$/i,
  Ue = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
  Be =
    /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
  Fe = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
...
function tt(r, e) {
  return !!(((e === "v4" || !e) && qe.test(r)) || ((e === "v6" || !e) && Ye.test(r)));
}
function rt(r, e) {
  if (!Ue.test(r)) return !1;
  try {
    const [t] = r.split(".");
    if (!t) return !1;
    const s = t
...
class C extends _ {
  _parse(e) {
    if ((this._def.coerce && (e.data = String(e.data)), this._getType(e) !== f.string)) {
      ...
      return (l(a, { code: d.invalid_type, expected: f.string, received: a.parsedType }), m);
    }
    const s = new b();
    let n;
    for (const a of this._def.checks)
      if (a.kind === "min")
        ...
        Fe.test(e.data) ||
          ((n = this._getOrReturnCtx(e, n)),
          l(n, { validation: "email", code: d.invalid_string, message: a.message }),
          s.dirty());
      else if (a.kind === "emoji")
        (G || (G = new RegExp(We, "u")),
          G.test(e.data) ||
            ((n = this._getOrReturnCtx(e, n)),
            l(n, { validation: "emoji", code: d.invalid_string, message: a.message }),
            s.dirty()));
      else if (a.kind === "uuid")
        Le.test(e.data) ||
          ((n = this._getOrReturnCtx(e, n)),
          l(n, { validation: "uuid", code: d.invalid_string, message: a.message }),
          s.dirty());
      else if (a.kind === "nanoid")
        De.test(e.data) ||
          ((n = this._getOrReturnCtx(e, n)),
          l(n, { validation: "nanoid", code: d.invalid_string, message: a.message }),
          s.dirty());
      else if (a.kind === "cuid")
        Ve.test(e.data) ||
          ((n = this._getOrReturnCtx(e, n)),
          l(n, { validation: "cuid", code: d.invalid_string, message: a.message }),
          s.dirty());
      else if (a.kind === "cuid2")
        ze.test(e.data) ||
          ((n = this._getOrReturnCtx(e, n)),
          l(n, { validation: "cuid2", code: d.invalid_string, message: a.message }),
          s.dirty());
      else if (a.kind === "ulid")
        Me.test(e.data) ||
          ((n = this._getOrReturnCtx(e, n)),
          l(n, { validation: "ulid", code: d.invalid_string, message: a.message }),
          s.dirty());
      else if (a.kind === "url")
        try {
          new URL(e.data);
          ...
          ((n = this._getOrReturnCtx(e, n)),
            l(n, { validation: "url", code: d.invalid_string, message: a.message }),
            s.dirty());
        }
      else
        a.kind === "regex"
          ? ((a.regex.lastIndex = 0),
            a.regex.test(e.data) ||
              ((n = this._getOrReturnCtx(e, n)),
              l(n, { validation: "regex", code: d.invalid_string, message: a.message }),
              s.dirty()))
          : a.kind === "trim"
            ? (e.data = e.data.trim())
            : a.kind === "includes"
...
class j extends _ {
  ...
  _parse(e) {
    if ((this._def.coerce && (e.data = Number(e.data)), this._getType(e) !== f.number)) {
      const a = this._getOrReturnCtx(e);
      return (l(a, { code: d.invalid_type, expected: f.number, received: a.parsedType }), m);
    }
    let s;
    const n = new b();
    for (const a of this._def.checks)
        ...
        : a.kind === "min"
          ...
          : a.kind === "max"
            ...
            : a.kind === "multipleOf"
              ? nt(e.data, a.value) !== 0 &&
                ((s = this._getOrReturnCtx(e, s)),
                l(s, { code: d.not_multiple_of, multipleOf: a.value, message: a.message }),
                n.dirty())
              : a.kind === "finite"
                ? Number.isFinite(e.data) ||
                  ((s = this._getOrReturnCtx(e, s)),
                  l(s, { code: d.not_finite, message: a.message }),
                  n.dirty())
                : v.assertNever(a);
  ...
  setLimit(e, t, s, n) {
    return new j({
      ...this._def,
      checks: [...this._def.checks, { kind: e, value: t, inclusive: s, message: h.toString(n) }],
    });
  }
  _addCheck(e) {
...
class E extends _ {
  ...
  _getInvalidInput(e) {
    ...
    return (l(t, { code: d.invalid_type, expected: f.bigint, received: t.parsedType }), m);
  }
  gte(e, t) {
    return this.setLimit("min", e, !0, h.toString(t));
  }
...
class W extends _ {
  _parse(e) {
    if ((this._def.coerce && (e.data = !!e.data), this._getType(e) !== f.boolean)) {
      ...
      return (l(s, { code: d.invalid_type, expected: f.boolean, received: s.parsedType }), m);
    }
    return w(e.data);
  }
}
W.create = (r) =>
  new W({ typeName: p.ZodBoolean, coerce: (r == null ? void 0 : r.coerce) || !1, ...g(r) });
class P extends _ {
  _parse(e) {
    if ((this._def.coerce && (e.data = new Date(e.data)), this._getType(e) !== f.date)) {
      const a = this._getOrReturnCtx(e);
      return (l(a, { code: d.invalid_type, expected: f.date, received: a.parsedType }), m);
    }
    if (Number.isNaN(e.data.getTime())) {
      const a = this._getOrReturnCtx(e);
      return (l(a, { code: d.invalid_date }), m);
    }
    const s = new b();
    let n;
    for (const a of this._def.checks)
...
class ue extends _ {
  _parse(e) {
    if (this._getType(e) !== f.symbol) {
      const s = this._getOrReturnCtx(e);
      return (l(s, { code: d.invalid_type, expected: f.symbol, received: s.parsedType }), m);
    }
    return w(e.data);
  }
}
ue.create = (r) => new ue({ typeName: p.ZodSymbol, ...g(r) });
class le extends _ {
  _parse(e) {
    if (this._getType(e) !== f.undefined) {
      const s = this._getOrReturnCtx(e);
      return (l(s, { code: d.invalid_type, expected: f.undefined, received: s.parsedType }), m);
    }
    return w(e.data);
  }
}
le.create = (r) => new le({ typeName: p.ZodUndefined, ...g(r) });
class fe extends _ {
  _parse(e) {
    if (this._getType(e) !== f.null) {
      const s = this._getOrReturnCtx(e);
      return (l(s, { code: d.invalid_type, expected: f.null, received: s.parsedType }), m);
    }
    return w(e.data);
  }
}
fe.create = (r) => new fe({ typeName: p.ZodNull, ...g(r) });
class he extends _ {
  constructor() {
...
he.create = (r) => new he({ typeName: p.ZodAny, ...g(r) });
class me extends _ {
  constructor() {
...
me.create = (r) => new me({ typeName: p.ZodUnknown, ...g(r) });
class Z extends _ {
  _parse(e) {
    const t = this._getOrReturnCtx(e);
    return (l(t, { code: d.invalid_type, expected: f.never, received: t.parsedType }), m);
  }
}
Z.create = (r) => new Z({ typeName: p.ZodNever, ...g(r) });
class pe extends _ {
  _parse(e) {
    if (this._getType(e) !== f.undefined) {
      const s = this._getOrReturnCtx(e);
      return (l(s, { code: d.invalid_type, expected: f.void, received: s.parsedType }), m);
    }
    return w(e.data);
  }
}
pe.create = (r) => new pe({ typeName: p.ZodVoid, ...g(r) });
class O extends _ {
  _parse(e) {
    const { ctx: t, status: s } = this._processInputParams(e),
      n = this._def;
    if (t.parsedType !== f.array)
      return (l(t, { code: d.invalid_type, expected: f.array, received: t.parsedType }), m);
    ...
    if (
      ...
      return Promise.all(
        [...t.data].map((i, o) => n.type._parseAsync(new A(t, i, t.path, o))),
...
class x extends _ {
  ...
  _parse(e) {
    if (this._getType(e) !== f.object) {
      ...
      return (l(u, { code: d.invalid_type, expected: f.object, received: u.parsedType }), m);
    }
    ...
    if (!(this._def.catchall instanceof Z && this._def.unknownKeys === "strip"))
      for (const u in n.data) i.includes(u) || o.push(u);
    const c = [];
    for (const u of i) {
      const y = a[u],
        k = n.data[u];
      c.push({
        ...
        value: y._parse(new A(n, k, n.path, u)),
    ...
    if (this._def.catchall instanceof Z) {
      ...
      if (u === "passthrough")
        ...
        o.length > 0 && (l(n, { code: d.unrecognized_keys, keys: o }), s.dirty());
      else if (u !== "strip")
      ...
      for (const y of o) {
        ...
        c.push({
          key: { status: "valid", value: y },
          value: u._parse(new A(n, k, n.path, y)),
      ...
      ? Promise.resolve()
          .then(async () => {
            ...
            for (const y of c) {
              const k = await y.key,
                L = await y.value;
              u.push({ key: k, value: L, alwaysSet: y.alwaysSet });
            }
            return u;
          })
          .then((u) => b.mergeObjectSync(s, u))
      : b.mergeObjectSync(s, c);
  }
  get shape() {
        ...
        ...(e !== void 0
          ? {
              errorMap: (t, s) => {
                var a, i;
                const n =
                  ((i = (a = this._def).errorMap) == null ? void 0 : i.call(a, t, s).message) ??
                  s.defaultError;
  ...
  keyof() {
    return Se(v.objectKeys(this.shape));
  }
}
x.create = (r, e) =>
  new x({
...
x.lazycreate = (r, e) =>
  new x({ shape: r, unknownKeys: "strip", catchall: Z.create(), typeName: p.ZodObject, ...g(e) });
class q extends _ {
  _parse(e) {
    ...
    function n(a) {
      ...
      return (l(t, { code: d.invalid_union, unionErrors: i }), m);
    }
    if (t.common.async)
      return Promise.all(
        s.map(async (a) => {
      ...
      ).then(n);
    {
      ...
      for (const c of s) {
        const u = { ...t, common: { ...t.common, issues: [] }, parent: null },
          y = c._parseSync({ data: t.data, path: t.path, parent: u });
        if (y.status === "valid") return y;
        (y.status === "dirty" && !a && (a = { result: y, ctx: u }),
          u.common.issues.length && i.push(u.common.issues));
      }
      if (a) return (t.common.issues.push(...a.ctx.common.issues), a.result);
      const o = i.map((c) => new T(c));
      return (l(t, { code: d.invalid_union, unionErrors: o }), m);
    }
  }
  get options() {
...
q.create = (r, e) => new q({ options: r, typeName: p.ZodUnion, ...g(e) });
function K(r, e) {
  const t = S(r),
    s = S(e);
  if (r === e) return { valid: !0, data: r };
  if (t === f.object && s === f.object) {
    const n = v.objectKeys(e),
      a = v.objectKeys(r).filter((o) => n.indexOf(o) !== -1),
      i = { ...r, ...e };
    for (const o of a) {
      const c = K(r[o], e[o]);
...
class J extends _ {
  _parse(e) {
    const { status: t, ctx: s } = this._processInputParams(e),
      n = (a, i) => {
        if (oe(a) || oe(i)) return m;
        const o = K(a.value, i.value);
        return o.valid
          ? ((de(a) || de(i)) && t.dirty(), { status: t.value, value: o.data })
          : (l(s, { code: d.invalid_intersection_types }), m);
      };
...
J.create = (r, e, t) => new J({ left: r, right: e, typeName: p.ZodIntersection, ...g(t) });
class R extends _ {
  _parse(e) {
    const { status: t, ctx: s } = this._processInputParams(e);
    if (s.parsedType !== f.array)
      return (l(s, { code: d.invalid_type, expected: f.array, received: s.parsedType }), m);
    ...
    const a = [...s.data]
      .map((i, o) => {
        ...
        return c ? c._parse(new A(s, i, s.path, o)) : null;
      })
      .filter((i) => !!i);
...
R.create = (r, e) => {
  ...
  return new R({ items: r, typeName: p.ZodTuple, rest: null, ...g(e) });
};
class ye extends _ {
  get keySchema() {
  ...
  _parse(e) {
    ...
    if (s.parsedType !== f.map)
      return (l(s, { code: d.invalid_type, expected: f.map, received: s.parsedType }), m);
    const n = this._def.keyType,
      a = this._def.valueType,
      i = [...s.data.entries()].map(([o, c], u) => ({
        key: n._parse(new A(s, o, s.path, [u, "key"])),
        value: a._parse(new A(s, c, s.path, [u, "value"])),
      }));
    if (s.common.async) {
      const o = new Map();
      return Promise.resolve().then(async () => {
        for (const c of i) {
          const u = await c.key,
            y = await c.value;
          if (u.status === "aborted" || y.status === "aborted") return m;
...
ye.create = (r, e, t) => new ye({ valueType: e, keyType: r, typeName: p.ZodMap, ...g(t) });
class U extends _ {
  _parse(e) {
    const { status: t, ctx: s } = this._processInputParams(e);
    if (s.parsedType !== f.set)
      return (l(s, { code: d.invalid_type, expected: f.set, received: s.parsedType }), m);
    const n = this._def;
    (n.minSize !== null &&
    ...
    function i(c) {
      const u = new Set();
      for (const y of c) {
        if (y.status === "aborted") return m;
        (y.status === "dirty" && t.dirty(), u.add(y.value));
      }
      return { status: t.value, value: u };
    }
    const o = [...s.data.values()].map((c, u) => a._parse(new A(s, c, s.path, u)));
    return s.common.async ? Promise.all(o).then((c) => i(c)) : i(o);
  }
  min(e, t) {
    return new U({ ...this._def, minSize: { value: e, message: h.toString(t) } });
  }
  max(e, t) {
    return new U({ ...this._def, maxSize: { value: e, message: h.toString(t) } });
  }
  size(e, t) {
...
U.create = (r, e) =>
  new U({ valueType: r, minSize: null, maxSize: null, typeName: p.ZodSet, ...g(e) });
class ge extends _ {
  get schema() {
...
ge.create = (r, e) => new ge({ getter: r, typeName: p.ZodLazy, ...g(e) });
class ee extends _ {
  _parse(e) {
    if (e.data !== this._def.value) {
      const t = this._getOrReturnCtx(e);
      return (l(t, { received: t.data, code: d.invalid_literal, expected: this._def.value }), m);
    }
...
ee.create = (r, e) => new ee({ value: r, typeName: p.ZodLiteral, ...g(e) });
function Se(r, e) {
  return new V({ values: r, typeName: p.ZodEnum, ...g(e) });
}
class V extends _ {
  _parse(e) {
    if (typeof e.data != "string") {
      const t = this._getOrReturnCtx(e),
        s = this._def.values;
      return (l(t, { expected: v.joinValues(s), received: t.parsedType, code: d.invalid_type }), m);
    }
    if ((this._cache || (this._cache = new Set(this._def.values)), !this._cache.has(e.data))) {
      const t = this._getOrReturnCtx(e),
        s = this._def.values;
      return (l(t, { received: t.data, code: d.invalid_enum_value, options: s }), m);
    }
    return w(e.data);
  }
  get options() {
...
class _e extends _ {
  _parse(e) {
    ...
    if (s.parsedType !== f.string && s.parsedType !== f.number) {
      ...
      return (l(s, { expected: v.joinValues(n), received: s.parsedType, code: d.invalid_type }), m);
    }
    if (
      ...
      const n = v.objectValues(t);
      return (l(s, { received: s.data, code: d.invalid_enum_value, options: n }), m);
    }
    return w(e.data);
  }
  get enum() {
...
_e.create = (r, e) => new _e({ values: r, typeName: p.ZodNativeEnum, ...g(e) });
class Y extends _ {
  unwrap() {
    return this._def.type;
  }
  _parse(e) {
    ...
    if (t.parsedType !== f.promise && t.common.async === !1)
      return (l(t, { code: d.invalid_type, expected: f.promise, received: t.parsedType }), m);
...
Y.create = (r, e) => new Y({ type: r, typeName: p.ZodPromise, ...g(e) });
class z extends _ {
  innerType() {
...
z.create = (r, e, t) => new z({ schema: r, typeName: p.ZodEffects, effect: e, ...g(t) });
...
N.create = (r, e) => new N({ innerType: r, typeName: p.ZodOptional, ...g(e) });
class M extends _ {
  _parse(e) {
...
M.create = (r, e) => new M({ innerType: r, typeName: p.ZodNullable, ...g(e) });
class te extends _ {
  _parse(e) {
    const { ctx: t } = this._processInputParams(e);
    let s = t.data;
...
class ve extends _ {
  _parse(e) {
    if (this._getType(e) !== f.nan) {
      const s = this._getOrReturnCtx(e);
      return (l(s, { code: d.invalid_type, expected: f.nan, received: s.parsedType }), m);
    }
    return { status: "valid", value: e.data };
  }
}
ve.create = (r) => new ve({ typeName: p.ZodNaN, ...g(r) });
class at extends _ {
  _parse(e) {
    const { ctx: t } = this._processInputParams(e),
      s = t.data;
...
class se extends _ {
  _parse(e) {
    const t = this._def.innerType._parse(e),
      s = (n) => ($(n) && (n.value = Object.freeze(n.value)), n);
...
se.create = (r, e) => new se({ innerType: r, typeName: p.ZodReadonly, ...g(e) });
var p;
(function (r) {
...
const bt = {
    ...
    boolean: (r) => W.create({ ...r, coerce: !0 }),
    bigint: (r) => E.create({ ...r, coerce: !0 }),
    date: (r) => P.create({ ...r, coerce: !0 }),
  },
  xe = (r, e, t) => {
  ...
  ne = (r, e) => {
    for (const t in e.fields) {
      ...
      s && s.ref && "reportValidity" in s.ref
        ? xe(s.ref, t, r)
        : s && s.refs && s.refs.forEach((n) => xe(n, t, r));
    }
  },
  ke = (r, e) => {
    e.shouldUseNativeValidation && ne(r, e);
    const t = {};
    for (const s in r) {
      const n = Q(e.fields, s),
        a = Object.assign(r[s] || {}, { ref: n && n.ref });
      if (it(e.names || Object.keys(r), s)) {
        const i = Object.assign({}, Q(t, s));
        (H(i, "root", a), H(t, s, i));
      } else H(t, s, a);
    }
    return t;
  ...
  it = (r, e) => {
    const t = be(e);
    return r.some((s) => be(s).match(`^${t}\\.\\d+`));
  };
function be(r) {
  return r.replace(/\]|\[/g, "");
}
function Ne(r, e, t) {
  ...
  function i(o) {
    ...
    for (const y of u._zod.deferred) y();
    return u;
  }
  return (
    ...
    Object.defineProperty(i, Symbol.hasInstance, {
      value: (o) => {
        var c, u;
        return t != null && t.Parent && o instanceof t.Parent
          ? !0
          : (u = (c = o == null ? void 0 : o._zod) == null ? void 0 : c.traits) == null
            ? void 0
            : u.has(r);
      },
    }),
...
const Ze = "captureStackTrace" in Error ? Error.captureStackTrace : (...r) => {};
function B(r) {
...
function je(r, e, t) {
  ...
  if (!r.message) {
    const y =
      B(
        (i = (a = (n = r.inst) == null ? void 0 : n._zod.def) == null ? void 0 : a.error) == null
          ? void 0
          : i.call(a, r),
      ) ??
      B((o = e == null ? void 0 : e.error) == null ? void 0 : o.call(e, r)) ??
      B((c = t.customError) == null ? void 0 : c.call(t, r)) ??
      B((u = t.localeError) == null ? void 0 : u.call(t, r)) ??
      "Invalid input";
    s.message = y;
  }
    ...
    if (
      ("unionErrors" in s &&
        s.unionErrors.forEach(function (y) {
          return y.errors.forEach(function (k) {
            return r.push(k);
          });
        }),
      e)
      ...
      var c = t[i].types,
        u = c && c[s.code];
      t[i] = Oe(i, e, t, n, u ? [].concat(u, s.message) : s.message);
    }
    r.shift();
  }
  return t;
    ...
    return function (s, n, a) {
      try {
        return Promise.resolve(
          we(
            function () {
              return Promise.resolve(r[t.mode === "sync" ? "parse" : "parseAsync"](s, e)).then(
                function (i) {
                  return (
                    a.shouldUseNativeValidation && ne({}, a),
                    { errors: {}, values: t.raw ? Object.assign({}, s) : i }
                  );
                },
              );
            },
            function (i) {
              if (
                ...
                return {
                  values: {},
                  errors: ke(
                    pt(i.errors, !a.shouldUseNativeValidation && a.criteriaMode === "all"),
                    a,
                  ),
                };
              throw i;
    ...
    return function (s, n, a) {
      try {
        return Promise.resolve(
          we(
            function () {
              return Promise.resolve((t.mode === "sync" ? ft : mt)(r, s, e)).then(function (i) {
                return (
                  a.shouldUseNativeValidation && ne({}, a),
                  { errors: {}, values: t.raw ? Object.assign({}, s) : i }
                );
            ...
            function (i) {
              if (
                ...
                return {
                  values: {},
                  errors: ke(
                    yt(i.issues, !a.shouldUseNativeValidation && a.criteriaMode === "all"),
                    a,
                  ),
                };
              throw i;
...
export { wt as a, bt as c, kt as e, xt as l, vt as o, _t as s };
