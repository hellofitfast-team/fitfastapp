...
const Te = (e, t) => {
  ...
  we = (e = new Map(), t = null, r) => ({ nextPart: e, validators: t, classGroupId: r }),
  K = "-",
  ue = [],
  je = "arbitrary..",
  Le = (e) => {
    ...
    return {
      getClassGroupId: (a) => {
        if (a.startsWith("[") && a.endsWith("]")) return Ee(a);
        const u = a.split(K),
  ...
  Ue = (e) => {
    ...
    const i = (d, a) => {
      ((r[d] = a), t++, t > e && ((t = 0), (o = r), (r = Object.create(null))));
    };
    return {
      get(d) {
        let a = r[d];
        if (a !== void 0) return a;
        if ((a = o[d]) !== void 0) return (i(d, a), a);
      },
      set(d, a) {
        d in r ? (r[d] = a) : i(d, a);
      },
  ...
  Xe = (e) => ({ cache: Ue(e.cacheSize), parseClassName: Ye(e), sortModifiers: qe(e), ...Le(e) }),
  Je = /\s+/,
  He = (e, t) => {
    const {
        parseClassName: r,
  ...
  Ke = (...e) => {
    let t = 0,
      ...
      o,
      i = "";
    for (; t < e.length; ) (r = e[t++]) && (o = ve(r)) && (i && (i += " "), (i += o));
    return i;
  },
  ve = (e) => {
    ...
    let t,
      r = "";
    for (let o = 0; o < e.length; o++) e[o] && (t = ve(e[o])) && (r && (r += " "), (r += t));
    return r;
  },
  Qe = (e, ...t) => {
    let r, o, i, d;
  ...
  wo = () => {
    const e = b("color"),
      ...
      m = () => [n, s, c],
      C = () => [N, "full", "auto", ...m()],
      ne = () => [R, "none", "subgrid", n, s],
      ae = () => ["auto", { span: ["full", R, n, s] }, R, n, s],
      U = () => [R, "auto", n, s],
      ...
      l = () => [e, n, s],
      le = () => [...j(), he, ge, { position: [n, s] }],
      ce = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      de = () => ["auto", "cover", "contain", bo, po, { size: [n, s] }],
      Z = () => [oe, B, O],
      x = () => ["", "none", "full", f, n, s],
      k = () => ["", p, B, O],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: ["auto", "square", N, s, n, w] }],
        container: ["container"],
        ...
        "max-w": [{ "max-w": [u, "screen", "none", "prose", { screen: [a] }, ...T()] }],
        h: [{ h: ["screen", "lh", ...T()] }],
        "min-h": [{ "min-h": ["screen", "lh", "none", ...T()] }],
        "max-h": [{ "max-h": ["screen", "lh", ...T()] }],
        "font-size": [{ text: ["base", r, B, O] }],
        "font-smoothing": ["antialiased", "subpixel-antialiased"],
        "font-style": ["italic", "not-italic"],
        "font-weight": [{ font: [o, n, re] }],
        "font-stretch": [
          {
            "font-stretch": [
              "ultra-condensed",
        ...
        "line-clamp": [{ "line-clamp": [p, "none", n, re] }],
        leading: [{ leading: [d, ...m()] }],
        ...
        "text-shadow": [{ "text-shadow": ["none", z, H, J] }],
